...
def query_func(features_folder, features_csv, model_file, classes, output_folder):
    ...
    for c in class_count:
        ...
        pairwise_outputs3 = torch.div(pairwise_outputs2, 100.0)
        ...
        df_outputs.to_csv(os.path.join(output_folder, 'apples_input_di_mtrx_query_{}.csv'.format(c)), index=False, sep='\t')


        logging.info('\n==> Computation is complete for subtree {}!\n'.format(c))
